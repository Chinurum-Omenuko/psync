	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/activities/_server.ts.js'))
			},
			{
				id: "/api/courses",
				pattern: /^\/api\/courses\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/courses/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/interests/project/_server.ts.js'))
			},
			{
				id: "/api/mail",
				pattern: /^\/api\/mail\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/mail/_server.ts.js'))
			},
			{
				id: "/api/projects",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/projects/_server.ts.js'))
			},
			{
				id: "/api/users",
				pattern: /^\/api\/users\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/users/_server.ts.js'))
			},
			{
